...
require_once(dirname(__FILE__).'/include_tcpdf/tcpdf_font_data.php');
// TCPDF static font methods and data
require_once(dirname(__FILE__).'/include_tcpdf/tcpdf_fonts.php');
// TCPDF static color methods and data
require_once(dirname(__FILE__).'/include_tcpdf/tcpdf_colors.php');
// TCPDF static image methods and data
require_once(dirname(__FILE__).'/include_tcpdf/tcpdf_images.php');
// TCPDF static methods and data
require_once(dirname(__FILE__).'/include_tcpdf/tcpdf_static.php');
